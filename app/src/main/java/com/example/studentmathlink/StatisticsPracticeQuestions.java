...
public class StatisticsPracticeQuestions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistics_practice_questions);
        ...
        questionList = questionBank.getStatisticsQuestions();
