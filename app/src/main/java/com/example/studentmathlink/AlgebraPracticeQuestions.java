...
public class AlgebraPracticeQuestions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_algebra_practice_questions);
        ...
        questionList = questionBank.getAlgebraQuestions();
    ...
    private void showIncorrectQuestions() {
        ...
        if (incorrectQuestions.isEmpty()) {
            ...
            perfectScoreTextView.setText("Congratulations! You answered all questions correctly.");
            ...
            for (int i = 0; i < incorrectQuestions.size(); i++) {
                ...
                questionNumberTextView.setTextSize(18);
